...
performance_ODTR = function(x, n, risk.type, DGP_fun, QAW, QAW.SL.library, blip.SL.library, dopt.SL.library, SL.type, moMain_model, moCont_model, grid.size){
 ...
 # grid.size = 100
  ...
  results = odtr(V=V, W=W, A=A, Y=Y, QAW.SL.library = QAW.SL.library, blip.SL.library=blip.SL.library,
              ...
              risk.type=risk.type, grid.size=grid.size, VFolds=VFolds, kappa = kappa, QAW = QAW,
