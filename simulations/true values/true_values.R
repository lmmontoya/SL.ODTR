...
##### DGP bin dep ######
DGP_bin_dep_true_values = get_true_vals(DGP_fun = DGP_bin_dep)
save(DGP_bin_dep_true_values, file = "/Users/juanmanuelramirez//Box Sync/SL.ODTR/simulations/true values/DGP_bin_dep_true_values.RData")
