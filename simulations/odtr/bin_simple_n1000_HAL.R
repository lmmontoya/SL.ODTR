...
risk.type = "CV MSE"
QAW.SL.library = c("SL.QAW.W1", "SL.QAW.W2", "SL.QAW.W3", "SL.QAW.W4", "SL.QAW.HTEepi")
blip.SL.library = c("SL.blip.W1", "SL.blip.W2", "SL.blip.W3", "SL.blip.W4", "SL.blip.HTEepi")
...
save(ODTRsimple_bliponlyparam_discrete_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyparam_discrete_n1000_HTE.RData")
...
save(ODTRsimple_bliponlyparam_blipmeta_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyparam_blipmeta_n1000_HTE.RData")
...
save(ODTRsimple_bliponlyparam_votemeta_CVTMLE,
     file = "results/ODTRsimple_bliponlyparam_votemeta_n1000_HTE.RData")
...
save(ODTRsimple_bliponlyML_discrete_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyML_discrete_n1000_HAL.RData")
...
save(ODTRsimple_bliponlyML_blipmeta_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyML_blipmeta_n1000_HAL.RData")
...
save(ODTRsimple_bliponlyML_votemeta_CVTMLE,
     file = "results/ODTRsimple_bliponlyML_votemeta_n1000_HAL.RData")
...
save(ODTRsimple_all_discrete_CVTMLE,
     file = "results/ODTRsimple_all_discrete_n1000_HAL.RData")
...
save(ODTRsimple_all_votemeta_CVTMLE,
     file = "results/ODTRsimple_all_votemeta_n1000_HAL.RData")
...
risk.type = "CV MSE"
QAW.SL.library = c("SL.glm", "SL.mean", "SL.glm.interaction", "SL.earth", "SL.nnet", "SL.svm", "SL.rpart", "SL.hal9001")
blip.SL.library = c("SL.glm", "SL.mean", "SL.glm.interaction", "SL.earth", "SL.nnet", "SL.svm", "SL.rpart", "SL.hal9001")
dopt.SL.library = NULL
metalearner = "discrete"
...
save(ODTRsimple_bliponlyMLonly_discrete_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyMLonly_discrete_n1000.RData")
...
save(ODTRsimple_bliponlyMLonly_blipmeta_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyMLonly_blipmeta_n1000_HAL.RData")
...
save(ODTRsimple_bliponlyMLonly_votemeta_CVTMLE,
     file = "results/ODTRsimple_bliponlyMLonly_votemeta_n1000_HAL.RData")
...
save(ODTRsimple_MLonlyEYd_discrete_CVTMLE,
     file = "results/ODTRsimple_MLonlyEYd_discrete_n1000_HAL.RData")
...
save(ODTRsimple_MLonlyEYd_votemeta_CVTMLE,
     file = "results/ODTRsimple_MLonlyEYd_votemeta_n1000_HAL.RData")
