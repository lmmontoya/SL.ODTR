...
save(ODTRcomplex_bliponlyparam_discrete_CVMSE,
     ...
     file = "results/ODTRcomplex_bliponlyparam_discrete_n300_HTE.RData")
...
save(ODTRcomplex_bliponlyparam_blipmeta_CVMSE,
     ...
     file = "results/ODTRcomplex_bliponlyparam_blipmeta_n300_HTE.RData")
...
save(ODTRcomplex_bliponlyparam_votemeta_CVTMLE,
     file = "results/ODTRcomplex_bliponlyparam_votemeta_n300_HTE.RData")
...
save(ODTRcomplex_bliponlyML_discrete_CVMSE,
     ...
     file = "results/ODTRcomplex_bliponlyML_discrete_n300_HAL.RData")
...
save(ODTRcomplex_bliponlyML_blipmeta_CVMSE,
     ...
     file = "results/ODTRcomplex_bliponlyML_blipmeta_n300_HAL.RData")
...
save(ODTRcomplex_bliponlyML_votemeta_CVTMLE,
     file = "results/ODTRcomplex_bliponlyML_votemeta_n300_HAL.RData")
...
save(ODTRcomplex_all_discrete_CVTMLE,
     file = "results/ODTRcomplex_all_discrete_n300_HAL.RData")
...
save(ODTRcomplex_all_votemeta_CVTMLE,
     file = "results/ODTRcomplex_all_votemeta_n300_HAL.RData")
...
save(ODTRcomplex_bliponlyMLonly_discrete_CVMSE,
     ...
     file = "results/ODTRcomplex_bliponlyMLonly_discrete_n300.RData")
...
save(ODTRcomplex_bliponlyMLonly_blipmeta_CVMSE,
     ...
     file = "results/ODTRcomplex_bliponlyMLonly_blipmeta_n300_HAL.RData")
...
save(ODTRcomplex_bliponlyMLonly_votemeta_CVTMLE,
     file = "results/ODTRcomplex_bliponlyMLonly_votemeta_n300_HAL.RData")
...
save(ODTRcomplex_MLonlyEYd_discrete_CVTMLE,
     file = "results/ODTRcomplex_MLonlyEYd_discrete_n300_HAL.RData")
...
save(ODTRcomplex_MLonlyEYd_votemeta_CVTMLE,
     file = "results/ODTRcomplex_MLonlyEYd_votemeta_n300_HAL.RData")
