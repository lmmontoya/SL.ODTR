...
require(gridExtra)
library('latex2exp')
source("/Users/linamontoya/Box Sync/SL.ODTR/simulations/showResults.R")
@
...
<<DGP_bin, echo = F>>=
# load DGP_bin stuff
load(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/true values/DGP_bin_simple_true_values.RData")
@

<<echo = F, results = 'asis', warning = F, fig.height=5.5, fig.width=12>>=
bin = list(ODTRsimple_GLM = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_GLM_n1000.RData"),
ODTRsimple_bliponlyparam_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyparam_discrete_n1000.RData"),
ODTRsimple_bliponlyparam_blipmeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyparam_blipmeta_n1000.RData"),
ODTRsimple_bliponlyparam_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyparam_votemeta_n1000.RData"),
ODTRsimple_bliponlyMLonly_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyMLonly_discrete_n1000.RData"),
ODTRsimple_bliponlyMLonly_blipmeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyMLonly_blipmeta_n1000.RData"),
ODTRsimple_bliponlyMLonly_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyMLonly_votemeta_n1000.RData"),
ODTRsimple_bliponlyML_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyML_discrete_n1000.RData"),
ODTRsimple_bliponlyML_blipmeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyML_blipmeta_n1000.RData"),
ODTRsimple_bliponlyML_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyML_votemeta_n1000.RData"),
ODTRsimple_MLonlyEYd_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_MLonlyEYd_discrete_n1000.RData"),
ODTRsimple_MLonlyEYd_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_MLonlyEYd_votemeta_n1000.RData"),
ODTRsimple_all_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_all_discrete_n1000.RData"),
ODTRsimple_all_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_all_votemeta_n1000.RData"))
...
BIN - simple blip - n = 1000 - for presentation


<<echo = F, results = 'asis', warning = F, fig.height=5.5, fig.width=12>>=
bin_pres = list(#ODTRsimple_GLM = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_GLM_n1000.RData"),
#ODTRsimple_bliponlyparam_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyparam_discrete_n1000.RData"),
ODTRsimple_bliponlyparam_blipmeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyparam_blipmeta_n1000.RData"),
ODTRsimple_bliponlyparam_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyparam_votemeta_n1000.RData"),
#ODTRsimple_bliponlyMLonly_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyMLonly_discrete_n1000.RData"),
...
odtr_pres = do.call('rbind', lapply(1:length(bin_pres), function(x) do.call("rbind", lapply(1:length(bin_pres[[x]]), makeplotdf_ODTR, ODTR = bin_pres[[x]], truevalues = DGP_bin_simple_true_values))))
...
odtr_plot_simple_n1000_pres =odtr_pres %>%
  ggplot(aes(x = Metalearner, y = Estimates, group = ALL, shape = Risk, col = Library)) +
  geom_point(size = 4, position = pd) +
  geom_errorbar(aes(ymin = minQ, ymax = maxQ, col = Library), width = .4, position = pd) +
  geom_hline(yintercept = (truevalues$EYd_star), colour = "black") +
...
<<echo = F, results = 'asis', warning = F, fig.height=5.5, fig.width=12>>=
bin_n300 = list(ODTRsimple_GLM = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_GLM_n300.RData"),
ODTRsimple_bliponlyparam_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyparam_discrete_n300.RData"),
ODTRsimple_bliponlyparam_blipmeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyparam_blipmeta_n300.RData"),
ODTRsimple_bliponlyparam_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyparam_votemeta_n300.RData"),
ODTRsimple_bliponlyMLonly_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyMLonly_discrete_n300.RData"),
ODTRsimple_bliponlyMLonly_blipmeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyMLonly_blipmeta_n300.RData"),
ODTRsimple_bliponlyMLonly_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyMLonly_votemeta_n300.RData"),
ODTRsimple_bliponlyML_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyML_discrete_n300.RData"),
ODTRsimple_bliponlyML_blipmeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyML_blipmeta_n300.RData"),
ODTRsimple_bliponlyML_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_bliponlyML_votemeta_n300.RData"),
ODTRsimple_MLonlyEYd_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_MLonlyEYd_discrete_n300.RData"),
ODTRsimple_MLonlyEYd_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_MLonlyEYd_votemeta_n300.RData"),
ODTRsimple_all_discrete = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_all_discrete_n300.RData"),
ODTRsimple_all_votemeta = load_object(file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/results/ODTRsimple_all_votemeta_n300.RData"))
...
write.csv(tableforpaper, "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/tables/bin_simple_tableforpaper.csv", row.names = F)

@


<<echo = F>>=
save(odtr_plot_simple_n1000, odtr_plot_simple_n300, odtr_plot_simple_n1000_pres, file = "/Users/linamontoya/Box Sync/SL.ODTR/simulations/odtr/figs/ODTR_simple_figs.RData")
@
