...
save(ODTRdep_incorrectglm_NA_NA,
     file = "results/ODTRdep_GLM_n300.RData")
...
save(ODTRdep_bliponlyparam_discrete_CVMSE,
     ...
     file = "results/ODTRdep_bliponlyparam_discrete_n300.RData")
...
save(ODTRdep_bliponlyparam_blipmeta_CVMSE,
     ...
     file = "results/ODTRdep_bliponlyparam_blipmeta_n300.RData")
...
save(ODTRdep_bliponlyparam_votemeta_CVTMLE,
     file = "results/ODTRdep_bliponlyparam_votemeta_n300.RData")
...
save(ODTRdep_bliponlyML_discrete_CVMSE,
     ...
     file = "results/ODTRdep_bliponlyML_discrete_n300.RData")
...
save(ODTRdep_bliponlyML_blipmeta_CVMSE,
     ...
     file = "results/ODTRdep_bliponlyML_blipmeta_n300.RData")
...
save(ODTRdep_bliponlyML_votemeta_CVTMLE,
     file = "results/ODTRdep_bliponlyML_votemeta_n300.RData")
...
save(ODTRdep_all_discrete_CVTMLE,
     file = "results/ODTRdep_all_discrete_n300.RData")
...
save(ODTRdep_all_votemeta_CVTMLE,
     file = "results/ODTRdep_all_votemeta_n300.RData")
...
save(ODTRdep_bliponlyMLonly_discrete_CVMSE,
     ...
     file = "results/ODTRdep_bliponlyMLonly_discrete_n300.RData")
...
save(ODTRdep_bliponlyMLonly_blipmeta_CVMSE,
     ...
     file = "results/ODTRdep_bliponlyMLonly_blipmeta_n300.RData")
...
save(ODTRdep_bliponlyMLonly_votemeta_CVTMLE,
     file = "results/ODTRdep_bliponlyMLonly_votemeta_n300.RData")
...
save(ODTRdep_MLonlyEYd_discrete_CVTMLE,
     file = "results/ODTRdep_MLonlyEYd_discrete_n300.RData")
...
save(ODTRdep_MLonlyEYd_votemeta_CVTMLE,
     file = "results/ODTRdep_MLonlyEYd_votemeta_n300.RData")
