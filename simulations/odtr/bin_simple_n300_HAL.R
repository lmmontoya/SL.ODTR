...
save(ODTRsimple_bliponlyparam_discrete_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyparam_discrete_n300_HTE.RData")
...
save(ODTRsimple_bliponlyparam_blipmeta_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyparam_blipmeta_n300_HTE.RData")
...
save(ODTRsimple_bliponlyparam_votemeta_CVTMLE,
     file = "results/ODTRsimple_bliponlyparam_votemeta_n300_HTE.RData")
...
save(ODTRsimple_bliponlyML_discrete_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyML_discrete_n300_HAL.RData")
...
save(ODTRsimple_bliponlyML_blipmeta_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyML_blipmeta_n300_HAL.RData")
...
save(ODTRsimple_bliponlyML_votemeta_CVTMLE,
     file = "results/ODTRsimple_bliponlyML_votemeta_n300_HAL.RData")
...
save(ODTRsimple_all_discrete_CVTMLE,
     file = "results/ODTRsimple_all_discrete_n300_HAL.RData")
...
save(ODTRsimple_all_votemeta_CVTMLE,
     file = "results/ODTRsimple_all_votemeta_n300_HAL.RData")
...
save(ODTRsimple_bliponlyMLonly_blipmeta_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyMLonly_blipmeta_n300_HAL.RData")
...
save(ODTRsimple_bliponlyMLonly_votemeta_CVTMLE,
     file = "results/ODTRsimple_bliponlyMLonly_votemeta_n300_HAL.RData")
...
save(ODTRsimple_MLonlyEYd_discrete_CVTMLE,
     file = "results/ODTRsimple_MLonlyEYd_discrete_n300_HAL.RData")
...
save(ODTRsimple_MLonlyEYd_votemeta_CVTMLE,
     file = "results/ODTRsimple_MLonlyEYd_votemeta_n300_HAL.RData")
