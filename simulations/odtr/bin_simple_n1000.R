...
save(ODTRsimple_incorrectglm_NA_NA,
     file = "results/ODTRsimple_GLM_n1000.RData")
...
save(ODTRsimple_bliponlyparam_discrete_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyparam_discrete_n1000.RData")
...
save(ODTRsimple_bliponlyparam_blipmeta_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyparam_blipmeta_n1000.RData")
...
save(ODTRsimple_bliponlyparam_votemeta_CVTMLE,
     file = "results/ODTRsimple_bliponlyparam_votemeta_n1000.RData")
...
save(ODTRsimple_bliponlyML_discrete_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyML_discrete_n1000.RData")
...
save(ODTRsimple_bliponlyML_blipmeta_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyML_blipmeta_n1000.RData")
...
save(ODTRsimple_bliponlyML_votemeta_CVTMLE,
     file = "results/ODTRsimple_bliponlyML_votemeta_n1000.RData")
...
save(ODTRsimple_all_discrete_CVTMLE,
     file = "results/ODTRsimple_all_discrete_n1000.RData")
...
save(ODTRsimple_all_votemeta_CVTMLE,
     file = "results/ODTRsimple_all_votemeta_n1000.RData")
...
save(ODTRsimple_bliponlyMLonly_blipmeta_CVMSE,
     ...
     file = "results/ODTRsimple_bliponlyMLonly_blipmeta_n1000.RData")
...
save(ODTRsimple_bliponlyMLonly_votemeta_CVTMLE,
     file = "results/ODTRsimple_bliponlyMLonly_votemeta_n1000.RData")
...
save(ODTRsimple_MLonlyEYd_discrete_CVTMLE,
     file = "results/ODTRsimple_MLonlyEYd_discrete_n1000.RData")
...
save(ODTRsimple_MLonlyEYd_votemeta_CVTMLE,
     file = "results/ODTRsimple_MLonlyEYd_votemeta_n1000.RData")
