...
save(alpha_psi_SL, c_psi_SL, dn_psi_SL, file = "results/psi_SL_null_obs.RData")
...
save(alpha_CI_SL, c_CI_SL, dn_CI_SL, file = "results/CI_SL_null_obs.RData")
