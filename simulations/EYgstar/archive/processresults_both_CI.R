...
load("simulations/EYgstar/CI_SL_simple.RData")
alpha = alpha_CI_SL
c = c_CI_SL
dn = dn_CI_SL
...
write.csv(table_simple, file = "simulations/EYgstar/table_simple_CI.csv", )
...
write.csv(table_complex, file = "simulations/EYgstar/table_complex_CI.csv", )
...
write.csv(table_null, file = "simulations/EYgstar/table_null_CI.csv", )
