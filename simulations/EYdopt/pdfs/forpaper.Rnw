...
<<EYdopt_DGP_smooth2_step1a, echo = F, warning = F, fig.height=5.5, fig.width=12>>=
load(file = "/Users/linamontoya/Box Sync/Dissertation/SL.ODTR/simulations/EYdopt/results/EYdopt_step1_smooth2.RData")
load(file = "/Users/linamontoya/Box Sync/Dissertation/SL.ODTR/simulations/EYdopt/results/EYdopt_step2_smooth2.RData")
load(file = "/Users/linamontoya/Box Sync/Dissertation/SL.ODTR/simulations/EYdopt/results/EYdopt_step3_smooth2.RData")
load(file = "/Users/linamontoya/Box Sync/Dissertation/SL.ODTR/simulations/EYdopt/results/EYdopt_step4_smooth2.RData")
load(file = "/Users/linamontoya/Box Sync/Dissertation/SL.ODTR/simulations/EYdopt/results/EYdopt_step5_smooth2.RData")
...
make_plot_EYdopt(EYdopt = EYdopt_step1_smooth2, truevalues = DGP_smooth2_true_values, title = "Correct GLMs")
make_plot_EYdopt(EYdopt = EYdopt_step2_smooth2, truevalues = DGP_smooth2_true_values, title = "Incorrect GLMs")
make_plot_EYdopt(EYdopt = EYdopt_step3_smooth2, truevalues = DGP_smooth2_true_values, title = "Non-overfit SL")
make_plot_EYdopt(EYdopt = EYdopt_step4_smooth2, truevalues = DGP_smooth2_true_values, title = "Overfit SL")
make_plot_EYdopt(EYdopt = EYdopt_step5_smooth2, truevalues = DGP_smooth2_true_values, title = "Very overfit SL")
...
<<>>=
# Correct GLM
make_table_EYdopt(EYdopt = EYdopt_step1_smooth2, truevalues = DGP_smooth2_true_values)
# Incorrect GLM
make_table_EYdopt(EYdopt = EYdopt_step2_smooth2, truevalues = DGP_smooth2_true_values)
# Non-overfit SL
make_table_EYdopt(EYdopt = EYdopt_step3_smooth2, truevalues = DGP_smooth2_true_values)
make_table_EYdopt(EYdopt = EYdopt_step4_smooth2, truevalues = DGP_smooth2_true_values)
make_table_EYdopt(EYdopt = EYdopt_step5_smooth2, truevalues = DGP_smooth2_true_values)
